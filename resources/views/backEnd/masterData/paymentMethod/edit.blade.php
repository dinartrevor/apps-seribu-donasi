                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="form-group">
                              ...
                              <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name_edit" autocomplate="off" placeholder="Enter Payment Method Name" value="{{ old('name') }}">
                              @error('name')
